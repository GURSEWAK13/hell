...
export default function Period() {
  ...
  const fetchPeriodData = async () => {
    try {
      ...
      const response = await axios.get(`https://fitsafar.onrender.com/api/period/data`, {
  ...
  const handleQuizSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://fitsafar.onrender.com/api/period/data`,
        {
  ...
  const handleEditSubmit = async () => {
    try {
      const token = localStorage.getItem('token')
      const response = await axios.post(`https://fitsafar.onrender.com/api/period/data`, 
        {
          lastPeriodDate: lastPeriod,
          cycleDuration: cycleLength,
          periodDuration: periodLength
